...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pdpbox-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7135&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pdpbox-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pdpbox` can be installed with:

```
conda install pdpbox
```

It is possible to list all of the versions of `pdpbox` available on your platform with:
